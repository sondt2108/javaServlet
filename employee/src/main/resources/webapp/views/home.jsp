        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <form action="home" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Department name</label>
                        <input type="hidden" name="id" value="${detailDept.getId()}"/>
                        <input type="text" name ="deptName" class="form-control" value="${detailDept.getDeptName()}" required>
                    </div>
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${dept}" var="dept">
                        <tr>
                            ...
                            <td><a href="?id=${dept.getId()}" class="btn btn-outline-info" >
                                <i class="fa-solid fa-pen"></i>
                            </a>
                                <form action="home" method="post" style="display: inline-block;">
